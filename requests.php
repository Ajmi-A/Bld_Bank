	...
	<tr>
		<td colspan="2"  align="center">
			<h2 style="padding:30px;">
				<b class="size_b">REQUEST</b> 
				<b class="size_r">BLOOD</b> 
			</h2>				
		</td>
	</tr>
 
<tr><td class="lefttd"> Name:</td><td><input type="text" name="t1" required="required" pattern="[a-zA-Z _]{5,15}" title="please enter only character  between 5 to 15 for donor name" /></td></tr>
 <tr><td>&nbsp;</td></tr>
...
<tr><td class="lefttd" >Mobile No</td><td><input type="number" name="t3"  required="required" pattern="[0-9]{10,12}" title="please enter only numbers between 10 to 12 for mobile no." /></td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td class="lefttd" >Select Blood Group </td><td><select style="width:62%;" name="t4" required><option value="">Select</option>
...
<tr><td class="lefttd" >E-Mail</td><td><input type="email" name="t5" required="required" /></td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td class="lefttd" >Till Required Date</td><td>
<select name="month">
...
<input type="text" name="year" style=" width:50px"  /></td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td class="lefttd"  >Detail</td><td><textarea name="t7"></textarea></td></tr>
 <tr><td>&nbsp;</td></tr>
