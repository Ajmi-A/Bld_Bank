...
<div class="reg_cont">
    ...
    <table  width="500px" height="300px" style="margin:auto;"> 
    <tbody>
        <tr style="margin:25px 0px;">
            <td align="center" colspan="2">
                <img src="Images/img/contact-us.png" width="80px" />
                <h2>
                    <b class="size_b">CONTACT</b> 
                    <b class="size_r">US</b> 
                </h2> 
            </td>
        </tr>
    ...
    <tr><td colspan="2">&nbsp;</td>
        ...
        <tr>
            <td align="center">
                <table cellpadding="5" cellspacing="5px" width="300px" height="250px">
                    <tbody>
                    <tr>
    ...
    <tr>
        <td class="lefttd" >Subject</td>
        <td><textarea name="t4" style="width: 79%;"></textarea></td>
    </tr>
